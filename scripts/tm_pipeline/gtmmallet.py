...
# Edited to run Seeded LDA and save noise distribution by Rob Churchill (March 2021)
...
class GTMMallet(utils.SaveLoad, basemodel.BaseTopicModel):
    """Python wrapper for Guided Topic Model (GTM) using `MALLET <http://mallet.cs.umass.edu/>`_.
    ...
    def __init__(self, mallet_path, corpus=None, num_topics=100, alpha=50, beta=0.01, id2word=None, workers=4, prefix=None,
        ...
        over_sampling_factor: double, optional
            the amount to oversample a seed word by in sampling scheme 1.  A value of 10 will oversample a seed word 10:1
    ...
    def load(cls, *args, **kwargs):
        ...
        """
        model = super(GTMMallet, cls).load(*args, **kwargs)
